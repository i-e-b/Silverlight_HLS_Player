...
namespace WMP_Controls
{
	public partial class WMP_Player_Controls : UserControl
	{
		...
		public WMP_Player_Controls()
		{
			...
			InitializeComponent();
			IsPlaying = false;
			ChunkSlider.NewChunkSelected += new EventHandler<ClickAnywhereSlider.ChunkChangeEventArgs>(ChunkSlider_NewChunkSelected);
		}
		...
		private bool _isUpdating = false; // nasty hack to get around inter-dependant event loops.
		...
		private string FormatTimeSpan (TimeSpan position) {
			string val = "";
		...
		private int _otherVolume = 0;
		public int Volume {
			get { if (VolumeSlider == null) return 50; return Math.Max((int)VolumeSlider.Value, 0); }
		}

		private void PlayPause6way_MouseLeftButtonUp (object sender, System.Windows.Input.MouseButtonEventArgs e) {
			OnTogglePlay(this, new EventArgs());
		}
		private void Stop6way_MouseLeftButtonUp (object sender, System.Windows.Input.MouseButtonEventArgs e) {
			OnStopVideo(this, e);
		}
		private void JumpBack6way_MouseLeftButtonUp (object sender, System.Windows.Input.MouseButtonEventArgs e) {
			OnJumpBack(this, e);
		}
		private void JumpForward6way_MouseLeftButtonUp (object sender, System.Windows.Input.MouseButtonEventArgs e) {
			OnJumpForward(this, e);
		}
		private void Mute6way_MouseLeftButtonUp (object sender, System.Windows.Input.MouseButtonEventArgs e) {
		...
		private void Rewind6way_MouseLeftButtonUp (object sender, System.Windows.Input.MouseButtonEventArgs e) {
			OnRewind(this, e);
		}
		private void FastForward6way_MouseLeftButtonUp (object sender, System.Windows.Input.MouseButtonEventArgs e) {
